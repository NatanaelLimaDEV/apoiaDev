                    ...
                    <div className="flex flex-col items-center sm:items-end sm:flex-row gap-4 sm:gap-6">
                        <div className="relative flex-shrink-0">
                            <Avatar className="h-20 w-20 border-2 md:border-4 border-white sm:w-24 sm:h-24 md:w-32 md:h-32 shadow-2xl group">
                                <AvatarImage src={profileImage} className="group-hover:scale-125 duration-300 group-hover:-rotate-6" />
                                <AvatarFallback className="text-lg md:text-xl font-bold">{name.split(" ").map((n) => n[0]).join("")}</AvatarFallback>
                            </Avatar>
                        </div>

                        <div className="pb-0 sm:pb-4">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-white text-center sm:text-left">{name}</h1>
                        </div>
                    </div>
                </div>
            </div>
